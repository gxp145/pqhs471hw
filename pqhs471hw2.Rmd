...
kable(mod.effect, col.names = 'r2')%>%
  kable_styling()
```
There is very little difference in RSS and all models account for the variation in applications quite well (r2 < .9). That said, PLS produces a model with the smallest test error and largest r2, though the absolute differences are tiny. That PCR is not considered: as no dimensions were reduced, it is equivalent to OLS. 
